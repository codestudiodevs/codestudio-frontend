...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/employee_schedule/index.vue?vue&type=template&id=6bc31ad6&
...
var employee_schedulevue_type_template_id_6bc31ad6_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.can(`employee_schedule_access`) ? _c('div', [_vm._ssrNode("<div class=\"text-center ma-2\">", "</div>", [_c(VSnackbar["a" /* default */], {
    attrs: {
      "top": "top",
      "color": "secondary",
      "elevation": "24"
  ...
  }, [_vm._v("\n          mdi mdi-close-circle\n        ")])], 1), _vm._v(" "), _c(components_VCard["d" /* VCardText */], [_c(VCol["a" /* default */], {
    staticClass: "text-right",
    attrs: {
      "col": "3",
      "text-right": ""
    }
  }, [_vm.isEdit ? _c(VBtn["a" /* default */], {
    staticClass: "primary",
    attrs: {
      "small": ""
    },
    on: {
      "click": function ($event) {
        return _vm.addRow(_vm.rosterFirstValue);
      }
    }
  }, [_c('b', [_vm._v("Add +")])]) : _vm._e()], 1), _vm._v(" "), _vm._l(_vm.schedules_temp_list, function (item, i) {
    return _c(VRow["a" /* default */], {
    ...
    }, [_c('div', {}, [_vm._v("Schedule List")]), _vm._v(" "), _c(VAutocomplete["a" /* default */], {
      attrs: {
        "outlined": "",
        "readonly": !_vm.isEdit,
        "dense": "",
      ...
      model: {
        ...
        callback: function ($$v) {
          _vm.$set(item, "schedule_id", $$v);
        },
        expression: "item.schedule_id"
      }
      ...
      staticClass: "mb-6"
    }, [_c('div', [_vm._v("From")]), _vm._v(" "), _c(VMenu["a" /* default */], {
      ref: "from_menu",
      refInFor: true,
      attrs: {
        "close-on-content-click": false,
        "return-value": item.from_date,
      ...
      on: {
        "update:returnValue": function ($event) {
          return _vm.$set(item, "from_date", $event);
        },
      ...
      scopedSlots: _vm._u([{
        ...
        fn: function ({
          ...
          }, 'v-text-field', !_vm.isEdit || attrs, false), !_vm.isEdit || on))];
        }
      }], null, true),
      model: {
        value: _vm.from_menu[i],
        callback: function ($$v) {
          _vm.$set(_vm.from_menu, i, $$v);
        },
        expression: "from_menu[i]"
      }
      ...
      on: {
        "click": function ($event) {
          _vm.isEdit ? _vm.set_date_save(_vm.$refs.from_menu[i], item.from_date, i) : '';
        }
      }
      ...
      staticClass: "mb-6"
    }, [_c('div', [_vm._v("To")]), _vm._v(" "), _c(VMenu["a" /* default */], {
      attrs: {
        "close-on-content-click": false,
        "nudge-right": 40,
        "transition": "scale-transition",
      ...
      model: {
        value: _vm.to_menu[i],
        callback: function ($$v) {
          _vm.$set(_vm.to_menu, i, $$v);
        },
        expression: "to_menu[i]"
      }
    }, [_vm._v(" "), _c(VDatePicker["a" /* default */], {
      attrs: {
        "readonly": !_vm.isEdit
      ...
      model: {
        value: item.is_over_time,
        callback: function ($$v) {
          _vm.$set(item, "is_over_time", $$v);
        },
        expression: "item.is_over_time"
      }
    })], 1)]), _vm._v(" "), _vm.isEdit ? _c(VCol["a" /* default */], {
      attrs: {
        "md": "1"
      }
    }, [_c('div'), _vm._v(" "), _c(VIcon["a" /* default */], {
      attrs: {
        "color": "error"
      },
      on: {
        "click": function ($event) {
          return _vm.removeItem(i, item);
        }
      }
    }, [_vm._v("mdi-delete")])], 1) : _vm._e()], 1);
  })], 2), _vm._v(" "), _c(VDivider["a" /* default */]), _vm._v(" "), _c(components_VCard["b" /* VCardActions */], [_c(VSpacer["a" /* default */]), _vm._v(" "), _vm.isEdit ? _c(VBtn["a" /* default */], {
    attrs: {
      "dark": "",
      "small": "",
      "color": "primary"
  ...
  }, [_vm._v(" Submit ")])], 1), _vm._v(" "), _c(VDivider["a" /* default */]), _vm._v(" "), _c(components_VCard["d" /* VCardText */], [_c(VRow["a" /* default */], [_c(VCol["a" /* default */], {
    attrs: {
      "md": "4"
    }
    ...
    attrs: {
      ...
      "item-value": "id",
      "item-text": "name",
      "disabled": _vm.is_edit == true ? true : false
    },
    on: {
      "change": _vm.runMultipleFunctions
    },
    model: {
    ...
    on: {
      "change": _vm.getEmployeesBySubDepartment
    },
    model: {
      value: _vm.sub_department_ids,
      callback: function ($$v) {
        _vm.sub_department_ids = $$v;
      },
      expression: "sub_department_ids"
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "mb-1"
  }, [_vm._v("Shift Types")]), _vm._v(" "), _c(VAutocomplete["a" /* default */], {
    attrs: {
      "error": _vm.errors && _vm.errors.shift_type_id,
      "error-messages": _vm.errors && _vm.errors.shift_type_id ? _vm.errors.shift_type_id[0] : '',
      "outlined": "",
      "dense": "",
      "x-small": "",
      "items": _vm.shift_types,
      "item-value": "id",
      "item-text": "name"
    },
    on: {
      "change": _vm.runShiftTypeFunction
    },
    model: {
    ...
    staticClass: "mb-1"
  }, [_vm._v("Shifts")]), _vm._v(" "), _c(VAutocomplete["a" /* default */], {
    attrs: {
      "error": _vm.errors && _vm.errors.shift_id,
      "error-messages": _vm.errors && _vm.errors.shift_id ? _vm.errors.shift_id[0] : '',
      "outlined": "",
      "dense": "",
      "x-small": "",
      "items": _vm.shifts,
    ...
    model: {
      value: _vm.isOverTime,
      callback: function ($$v) {
        _vm.isOverTime = $$v;
      },
      expression: "isOverTime"
    }
  })], 1)], 1)], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "md": "8"
    ...
    staticClass: "text-h6"
  }, [_vm._v("Employees List")])])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "md": "6"
    }
  }, [_c('div', {
    ...
    on: {
      "input": _vm.dialogSearchIt
    },
    model: {
      value: _vm.dialog_search,
      callback: function ($$v) {
        _vm.dialog_search = $$v;
      },
      expression: "dialog_search"
    }
    ...
    attrs: {
      ...
      "server-items-length": _vm.total_dialog,
      "loading": _vm.loading_dialog,
      "options": _vm.options_dialog,
      "footer-props": {
    ...
    on: {
      "update:options": function ($event) {
        _vm.options_dialog = $event;
      }
    },
    model: {
      value: _vm.employee_ids,
      callback: function ($$v) {
        _vm.employee_ids = $$v;
      },
      expression: "employee_ids"
    }
  })], 1)], 1)], 1), _vm._v(" "), _c(VDivider["a" /* default */]), _vm._v(" "), _c(components_VCard["b" /* VCardActions */], [_c(VSpacer["a" /* default */]), _vm._v(" "), _c(VBtn["a" /* default */], {
    attrs: {
      "dark": "",
      "small": "",
      "color": "grey"
  ...
  }, [_vm._v(" Submit ")])], 1)], 1)], 1), _vm._ssrNode(" "), _c(VCard["a" /* default */], {
    staticClass: "mb-5 rounded-md mt-3",
    attrs: {
      "elevation": "0"
    }
    ...
    }], null, false, 3875644392)
  }, [_vm._v(" "), _c('span', [_vm._v("Filter")])]), _vm._v(" "), _c(VSpacer["a" /* default */]), _vm._v(" "), _vm.can(`employee_schedule_create`) ? _c(VTooltip["a" /* default */], {
    attrs: {
      "top": "",
      "color": "primary"
    },
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_c(VBtn["a" /* default */], _vm._g(_vm._b({
          ...
          on: {
            "click": _vm.gotoCreateSchedule
          }
        }, [_vm._v("mdi mdi-plus-circle")])], 1)];
      }
    }], null, false, 1411348045)
  }, [_vm._v(" "), _c('span', [_vm._v("Add Schedule")])]) : _vm._e()], 1), _vm._v(" "), _c(VSnackbar["a" /* default */], {
    attrs: {
      "timeout": 3000,
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_vm.isFilter ? _c('tr', _vm._l(_vm.headers_table, function (header) {
          return _c('td', {
            key: header.text
          ...
          }) : _vm._e(), _vm._v(" "), header.filterSpecial && header.value == 'isOverTime' ? _c(VSelect["a" /* default */], {
            attrs: {
              "hide-details": true,
              "item-value": "value",
              "item-text": "title",
          ...
          }) : _vm._e(), _vm._v(" "), header.filterSpecial && header.value == 'shift.name' ? _c(VSelect["a" /* default */], {
            attrs: {
              "id": header.key,
              "hide-details": true,
              "outlined": "",
            ...
            model: {
              value: _vm.filters[header.filterName],
              callback: function ($$v) {
                _vm.$set(_vm.filters, header.filterName, $$v);
              },
              expression: "filters[header.filterName]"
            }
          }) : _vm._e(), _vm._v(" "), header.filterSpecial && header.value == 'shift_type.name' ? _c(VSelect["a" /* default */], {
            attrs: {
              "id": header.key,
              "hide-details": true,
              "outlined": "",
              ...
              "item-text": "name",
              "item-value": "id",
              "items": _vm.shiftsTypes_for_filter,
              "placeholder": "Shift",
              "solo": "",
              "flat": ""
            },
          ...
          }) : _vm._e(), _vm._v(" "), header.filterSpecial && header.value == 'from_date' ? _c(VMenu["a" /* default */], {
            ...
            scopedSlots: _vm._u([{
              ...
              fn: function ({
                ...
                return [_c(VTextField["a" /* default */], _vm._g(_vm._b({
                  attrs: {
                    "hide-details": !_vm.from_date_filter,
                    "outlined": "",
                    "dense": "",
                    "readonly": "",
            ...
            model: {
              value: _vm.from_menu_filter,
              callback: function ($$v) {
                _vm.from_menu_filter = $$v;
              },
              expression: "from_menu_filter"
            }
          }, [_vm._v(" "), _c(VDatePicker["a" /* default */], {
            staticStyle: {
              "height": "350px"
            ...
            on: {
              "click": function ($event) {
                ...
                _vm.from_menu_filter = false;
                _vm.applyFilter();
              }
            }
          }, [_vm._v("\n                  Clear\n                ")])], 1)], 1) : _vm._e(), _vm._v(" "), header.filterSpecial && header.value == 'to_date' ? _c(VMenu["a" /* default */], {
            ref: "to_menu_filter",
            refInFor: true,
            attrs: {
              "close-on-content-click": false,
            ...
            scopedSlots: _vm._u([{
              ...
              fn: function ({
                ...
                return [_c(VTextField["a" /* default */], _vm._g(_vm._b({
                  attrs: {
                    "hide-details": !_vm.to_date_filter,
                    "outlined": "",
                    "dense": "",
                    "readonly": "",
            ...
            model: {
              value: _vm.to_menu_filter,
              callback: function ($$v) {
                _vm.to_menu_filter = $$v;
              },
              expression: "to_menu_filter"
            }
          }, [_vm._v(" "), _c(VDatePicker["a" /* default */], {
            staticStyle: {
              "height": "350px"
      ...
      fn: function ({
        ...
        var _item$employee;
        return [_vm._v("\n        " + _vm._s(_vm.caps((item === null || item === void 0 ? void 0 : (_item$employee = item.employee) === null || _item$employee === void 0 ? void 0 : _item$employee.employee_id) || "")) + "\n      ")];
      }
    }, {
      key: "item.employee.first_name",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(_vm.caps(item.employee && item.employee.first_name)) + "\n        " + _vm._s(_vm.caps(item.employee && item.employee.last_name)) + "\n      ")];
      }
    }, {
      key: "item.roster.name",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(_vm.caps(item.roster && item.roster.name)) + "\n      ")];
      }
    }, {
      key: "item.show_from_date",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(item && item.from_date) + "\n      ")];
      }
    }, {
      key: "item.show.to_date",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(item && item.to_date) + "\n      ")];
      }
    }, {
      key: "item.isOverTime",
      fn: function ({
        ...
        return [item && item.isOverTime ? _c(VIcon["a" /* default */], {
          attrs: {
            "color": "success darken-1"
          }
        }, [_vm._v("mdi-check")]) : _c(VIcon["a" /* default */], {
          attrs: {
            "color": "error"
          }
        }, [_vm._v("mdi-close")])];
      ...
      fn: function ({
        ...
        return [_vm._v("\n        " + _vm._s(_vm.getCurrentShift(item)) + "\n      ")];
      }
    }, {
      key: "item.shift_type.name",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(item.shift_type && item.shift_type.name) + "\n      ")];
      }
    }, {
      key: "item.action",
      fn: function ({
        ...
        return [_c(VMenu["a" /* default */], {
          ...
          on: {
            "click": function ($event) {
              return _vm.ScheduleItem(item, 'view');
            }
          }
          ...
          on: {
            "click": function ($event) {
              return _vm.ScheduleItem(item, 'edit');
            }
          }
        }, [_c(components_VList["k" /* VListItemTitle */], {
          staticStyle: {
    ...
    }], null, false, 3200497840)
  })], 1)], 2) : _c('NoAccess');
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/employee_schedule/index.vue?vue&type=template&id=6bc31ad6&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/employee_schedule/index.vue?vue&type=script&lang=js&
/* harmony default export */ var employee_schedulevue_type_script_lang_js_ = ({
  data: () => ({
    shifts_for_filter: [],
  ...
  methods: {
    ...
    ScheduleItem(item, type) {
      ...
      this.$axios.get(`get_roster_by_employee/${id}`, {
        params: options
      }).then(({
        data
      }) => {
    ...
    getShifts(shift_type_id) {
      ...
      this.$axios.get("shift_by_type", options).then(({
        data
      }) => {
        this.shifts = data;
    ...
    getShiftsForFilter() {
      ...
      this.$axios.get("shift", options).then(({
        ...
        this.shifts_for_filter.unshift({
          id: "",
          name: "All"
        });
      }).catch(err => console.log(err));
      this.$axios.get("shift_type", options).then(({
        data
      }) => {
        this.shiftsTypes_for_filter = data;
        this.shiftsTypes_for_filter.unshift({
          id: "",
          name: "All"
        });
      }).catch(err => console.log(err));
    ...
    getShiftTypes(options) {
      this.$axios.get("shift_type", options).then(({
        ...
        this.shift_types.unshift({
          id: "",
          name: "Select Shift Type"
        });
      }).catch(err => console.log(err));
    },
    runShiftFunction() {
    ...
    employeesByDepartment() {
      ...
      this.$axios.get("employeesByDepartment", options).then(({
        data
      }) => {
    ...
    getEmployeesBySubDepartment() {
      ...
      this.$axios.get(`employeesBySubDepartment`, options).then(({
        data
      }) => {
        this.employees_dialog = data.data;
        this.total_dialog = data.total;
    ...
    subDepartmentsByDepartment() {
      ...
      this.$axios.get(`sub-departments-by-departments`, this.options).then(({
        data
      }) => {
    ...
    dialogSearchIt(e) {
      if (e.length == 0) {
        ...
        this.employees_dialog = this.employees.filter(({
          display_name: fn
        }) => fn.includes(e));
      }
    },
    delteteSelectedRecords() {
      ...
      confirm("Are you sure you wish to delete selected records , to mitigate any inconvenience in future.") && this.$axios.post(`schedule_employee/delete/selected`, {
        ids: just_ids
      }).then(({
        data
      }) => {
    ...
    deleteItem(item) {
      confirm("Are you sure you wish to delete , to mitigate any inconvenience in future.") && this.$axios.delete("schedule_employees/" + item.employee.system_user_id).then(({
        data
      }) => {
    ...
    save() {
      ...
      if (this.is_edit) {
        this.process(this.$axios.post(`schedule_employees/${payload.employee_ids}`, payload));
      } else {
    ...
    process(method) {
      method.then(({
        ...
        if (!data.status) {
          if (data !== null && data !== void 0 && data.custom_errors) {
...
// CONCATENATED MODULE: ./pages/employee_schedule/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_employee_schedulevue_type_script_lang_js_ = (employee_schedulevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(9);

// CONCATENATED MODULE: ./pages/employee_schedule/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_employee_schedulevue_type_script_lang_js_,
  employee_schedulevue_type_template_id_6bc31ad6_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* harmony default export */ var employee_schedule = __webpack_exports__["default"] = (component.exports);

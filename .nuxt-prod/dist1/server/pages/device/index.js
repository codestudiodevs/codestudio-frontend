...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/device/index.vue?vue&type=template&id=6388db00&
...
var devicevue_type_template_id_6388db00_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  }, [_vm._v("\n      " + _vm._s(_vm.response) + "\n    ")])], 1), _vm._ssrNode(" "), _c(VRow["a" /* default */]), _vm._ssrNode(" "), _c(VCard["a" /* default */], {
  ...
  }, [_c(components_VToolbar["c" /* VToolbarTitle */], [_c('span', [_vm._v(" Devices List")])]), _vm._v(" "), _c(VTooltip["a" /* default */], {
    attrs: {
      "top": "",
      "color": "primary"
    },
  ...
  }, [_vm._v(" "), _c('span', [_vm._v("Sync Devices")])])], 1), _vm._v(" "), _c(VSnackbar["a" /* default */], {
    attrs: {
      "timeout": 3000,
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_vm.isFilter ? _c('tr', _vm._l(headers, function (header) {
          return _c('td', {
          ...
          }) : header.filterSpecial && header.text == 'Status' ? _c(VSelect["a" /* default */], {
            attrs: {
              "hide-details": true,
              "item-value": "value",
              "item-text": "title",
            ...
            on: {
              "change": function ($event) {
                return _vm.applyFilters('status', $event);
              }
            },
            model: {
              value: _vm.filters[header.text],
              callback: function ($$v) {
                _vm.$set(_vm.filters, header.text, $$v);
              },
              expression: "filters[header.text]"
            }
          }) : _vm._e()], 1);
        }), 0) : _vm._e()];
      }
      ...
      fn: function ({
        ...
        return [_vm._v("\n        " + _vm._s(_vm.caps(item.short_name)) + "\n      ")];
      }
    }, {
      key: "item.location",
      fn: function ({
      ...
      fn: function ({
        ...
        return [_vm._v("\n        " + _vm._s(_vm.caps(item.device_type)) + "\n      ")];
      }
    }, {
      key: "item.status_id",
      fn: function ({
        ...
        }, [_vm._v("\n          " + _vm._s(item.status.name == "active" ? "online" : "offline") + "\n        ")])];
      }
    }, {
      key: "item.status",
      fn: function ({
        ...
        return [_c(VChip["a" /* default */], {
          ...
          on: {
            "click": function ($event) {
              return _vm.open_door(item.device_id);
            }
          }
          ...
          on: {
            "click": function ($event) {
              return _vm.open_door_always(item.device_id);
            }
          }
        }, [_vm._v("\n          Open Always\n        ")]), _vm._v(" "), _c(VChip["a" /* default */], {
          staticClass: "p-2",
      ...
      fn: function ({
        ...
        return [_c(VChip["a" /* default */], {
          ...
          on: {
            "click": function ($event) {
              return _vm.sync_date_time(item);
            }
          }
        }, [_vm._v("\n          " + _vm._s(item.sync_date_time == "---" ? "click to sync" : item.sync_date_time) + "\n        ")])];
      }
    }])
  })], 1)], 2);
};
...
// CONCATENATED MODULE: ./pages/device/index.vue?vue&type=template&id=6388db00&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/device/index.vue?vue&type=script&lang=js&
/* harmony default export */ var devicevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    sync_date_time(item) {
      ...
      this.$axios.get(`sync_device_date_time/${item.device_id}`, options).then(({
        data
      }) => {
        if (data.status) {
    ...
    open_door(device_id) {
      ...
      this.$axios.get(`open_door`, options).then(({
        data
      }) => {
        this.snackbar = true;
        this.response = data;
    ...
    open_door_always(device_id) {
      ...
      this.$axios.get(`open_door_always`, options).then(({
        data
      }) => {
        this.snackbar = true;
        this.response = data.message;
    ...
    close_door(device_id) {
      ...
      this.$axios.get(`close_door`, options).then(({
        data
      }) => {
        this.snackbar = true;
        this.response = data.message;
    ...
    async getDataFromApi(url = this.endpoint, filter_column = "", filter_value = "") {
      ...
      await this.$axios.get(`${url}?page=${page}`, options).then(({
        data
      }) => {
    ...
    async updateDevicesHealth() {
      ...
      await this.$axios.get("/check_device_health", options).then(({
        data
      }) => {
        this.snackbar = true;
        this.response = data;
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  devicevue_type_template_id_6388db00_render,
  staticRenderFns,
  false,
  null,
  null,

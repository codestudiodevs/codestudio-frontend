...
var editvue_type_template_id_e8d81b30_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticStyle: {
  ...
  }, [_vm._ssrNode("<div>", "</div>", [_c(VRow["a" /* default */], [_c('div', {
  ...
  }, [_vm._v("mdi mdi-format-list-bulleted-square")]), _vm._v("\n            View List\n          ")], 1)])])], 1), _vm._ssrNode(" "), _c(VRow["a" /* default */], [_c(VCol["a" /* default */], {
    attrs: {
      "cols": "5"
    }
...
// CONCATENATED MODULE: ./pages/timezonemapping/edit.vue?vue&type=template&id=e8d81b30&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/timezonemapping/edit.vue?vue&type=script&lang=js&
/* harmony default export */ var editvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getMappeddatafromAPI() {
      ...
      let page = 1;
      this.$axios.get(`${url}/${this.mappingtId}`, options).then(({
        data
      }) => {
        this.rightEmployees = data.employee_id;
        let url1 = "get_employeeswith_timezonename_id";
        this.$axios.get(`get_employeeswith_timezonename_id/${data.timezone_id}`, options).then(({
          data
        }) => {
        ...
        this.rightEmployees.map(e => ({
          id: e.id
        })).filter(re => {
          let selectedindex = this.leftEmployees.findIndex(le => re.id == le.id);
        ...
        this.rightDevices.map(e => ({
          id: e.id
        })).filter(re => {
          let selectedindex = this.leftDevices.findIndex(le => re.id == le.id);
    ...
    onSubmit() {
      ...
      this.$axios.put(`${url}/${idTable}`, options).then(({
        data
      }) => {
        // this.displaybutton = false;
...
// CONCATENATED MODULE: ./pages/timezonemapping/edit.vue?vue&type=script&lang=js&
 /* harmony default export */ var timezonemapping_editvue_type_script_lang_js_ = (editvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(9);

// CONCATENATED MODULE: ./pages/timezonemapping/edit.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  timezonemapping_editvue_type_script_lang_js_,
  editvue_type_template_id_e8d81b30_render,
  staticRenderFns,
  false,
  null,
  null,

...
var listvue_type_template_id_71bc8a86_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.can(`employee_access`) ? _c('div', [_vm._ssrNode("<div class=\"text-center ma-2\">", "</div>", [_c(VSnackbar["a" /* default */], {
  ...
  }, [_c(components_VToolbar["c" /* VToolbarTitle */], [_c('span', [_vm._v(" " + _vm._s(_vm.Model) + " ")])]), _vm._v(" "), _c(VTooltip["a" /* default */], {
    attrs: {
      "top": "",
      "color": "primary"
    },
    ...
    }], null, false, 3585096178)
  }, [_vm._v(" "), _c('span', [_vm._v("Filter")])]), _vm._v(" "), _c(VSpacer["a" /* default */]), _vm._v(" "), _c(components_VToolbar["b" /* VToolbarItems */], [_c(VCol["a" /* default */], {
    ...
    }], null, false, 1969911997)
  }, [_vm._v(" "), _c('span', [_vm._v("Add New Timezone")])])], 1)], 1)], 1), _vm._v(" "), _c(VSnackbar["a" /* default */], {
    attrs: {
      "timeout": 3000,
    ...
    scopedSlots: _vm._u([{
      ...
      key: "item.timezone.timezone_name",
      fn: function ({
        item
      }) {
        return [_vm._v("\n            " + _vm._s(item.timezone.timezone_name) + "\n          ")];
      }
    }, {
      key: "item.devices",
      fn: function ({
        ...
        return [_vm._l(item.device_id.slice(0, 3), function (subitem, index) {
          ...
          }, [_vm._v("\n              " + _vm._s(_vm.caps(subitem.location + " : " + subitem.name)) + "\n\n            ")]);
        }), _vm._v(" "), item.device_id.length > 3 ? _c(VBtn["a" /* default */], {
          attrs: {
            "small": "",
            "warning": ""
          },
          on: {
            "click": function ($event) {
              return _vm.displayView(item.id);
            }
          }
        }, [_vm._v("\n              All Devices\n            ")]) : _vm._e()];
      }
      ...
      fn: function ({
        ...
        return [_vm._l(item.employee_id.slice(0, 3), function (subitem, index) {
          return _c(VChip["a" /* default */], {
            key: index,
            staticClass: "primary ma-1",
            attrs: {
          ...
          }, [_vm._v("\n              " + _vm._s(_vm.caps(subitem.first_name + " " + subitem.last_name + " : " + subitem.employee_id)) + "\n\n            ")]);
        }), _vm._v(" "), item.employee_id.length > 3 ? _c(VBtn["a" /* default */], {
          attrs: {
            "small": "",
            "warning": ""
          },
      ...
      fn: function ({
        ...
        return [_c(VMenu["a" /* default */], {
          ...
          on: {
            "click": function ($event) {
              return _vm.displayEdit(item.id);
            }
          }
        }, [_c(components_VList["k" /* VListItemTitle */], {
          staticStyle: {
          ...
          on: {
            "click": function ($event) {
              return _vm.deleteItem(item.id, item.timezone_id);
            }
          }
        }, [_c(components_VList["k" /* VListItemTitle */], {
          staticStyle: {
    ...
    }], null, false, 3657004098)
  })], 1)], 1)], 1)], 2) : _vm._e();
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/timezonemapping/list.vue?vue&type=template&id=71bc8a86&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/timezonemapping/list.vue?vue&type=script&lang=js&
  ...
  methods: {
    ...
    getDeviceslist(devicesList) {
      ...
      devicesList.forEach(data1 => {
        deviceNames = deviceNames + data1.location + ": " + data1.name + " <br />";
      });
      return deviceNames;
    },
    getEmployeelist(employeesList) {
      ...
      employeesList.forEach(data1 => {
        employeeNames = employeeNames + data1.display_name + ": " + data1.employee_id + "<br />";
      });
    ...
    deleteItem(rowId, timezone_id) {
      ...
      confirm("Are you sure you want to delete this item?") && this.$axios.post(`${url}`, options).then(({
        data
      }) => {
        this.getDataFromApi();
        if (!data.status) {
    ...
    getDataFromApi(url = this.endpoint, additional_params) {
      ...
      if (additional_params != '') options.params['additional_params'] = additional_params;
      this.loading = true;
...
// CONCATENATED MODULE: ./pages/timezonemapping/list.vue?vue&type=script&lang=js&
 /* harmony default export */ var timezonemapping_listvue_type_script_lang_js_ = (listvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(9);

// CONCATENATED MODULE: ./pages/timezonemapping/list.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  timezonemapping_listvue_type_script_lang_js_,
  listvue_type_template_id_71bc8a86_render,
  staticRenderFns,
  false,
  null,
  null,

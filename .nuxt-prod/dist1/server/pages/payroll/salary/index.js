...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/payroll/salary/index.vue?vue&type=template&id=046beb68&
...
var salaryvue_type_template_id_046beb68_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.can(`employee_access`) ? _c('div', [_vm._ssrNode("<div class=\"text-center ma-2\">", "</div>", [_c(VSnackbar["a" /* default */], {
    ...
    model: {
      value: _vm.dialogPayslipsResults,
      callback: function ($$v) {
        _vm.dialogPayslipsResults = $$v;
      },
      expression: "dialogPayslipsResults"
    }
    ...
    on: {
      "click": function ($event) {
        _vm.dialogPayslipsResults = false;
      }
    }
  }, [_vm._v("\n           mdi mdi-close-circle\n         ")])], 1), _vm._v(" "), _c(components_VCard["d" /* VCardText */], [_c(VContainer["a" /* default */], [[_vm.payslipsResultsmessages.length ? _c('table', {
    staticStyle: {
      "width": "100%"
    }
  ...
  }, [_vm._v("Download")])])]), _vm._v(" "), _c('tbody', _vm._l(_vm.payslipsResultsmessages, function (item, index) {
    return _c('tr', {
      key: item.id,
      style: {
        color: item.status ? '' : 'red'
      }
    }, [_c('td', [_vm._v(_vm._s(index + 1))]), _vm._v(" "), _c('td', [_vm._v(_vm._s(item.status_message))]), _vm._v(" "), _c('td', {
      staticClass: "text-right"
    }, [item.status ? _c('a', {
      staticStyle: {
        "font-size": "25px",
      ...
      attrs: {
        "href": _vm.getdownloadLink(item.employee_id)
      }
    }, [_c(VIcon["a" /* default */], {
    ...
    }, [_vm._v("mdi-download")])], 1) : _vm._e(), _vm._v(" "), !item.status ? _c('a', {
      staticStyle: {
        "font-size": "14px",
        "vertical-align": "inherit",
        "cursor": "pointer"
      ...
      on: {
        "click": function ($event) {
          return _vm.navigatetoEmployeepage();
        }
      }
    }, [_vm._v("\n                       Go to Employee Page\n                     ")]) : _vm._e()])]);
  }), 0)]) : _c('div', [_vm._v("No Employees are available")])]], 2)], 1)], 1)], 1), _vm._ssrNode(" "), _c(VDialog["a" /* default */], {
    attrs: {
      "max-width": "500px"
    },
    model: {
  ...
  }) : _vm._e(), _vm._v(" "), _c('br'), _vm._v(" "), _c(components_VCard["d" /* VCardText */], [_c(VAutocomplete["a" /* default */], {
    attrs: {
    ...
    on: {
      "change": function ($event) {
        return _vm.getDataFromApi(`employee`);
      }
    },
    model: {
    ...
    on: {
      "change": _vm.handleFilters
    },
    model: {
      value: _vm.payslip_year,
      callback: function ($$v) {
        _vm.payslip_year = $$v;
      },
      expression: "payslip_year"
    }
  }), _vm._v(" "), _c(VAutocomplete["a" /* default */], {
    attrs: {
      "outlined": "",
    ...
    model: {
      value: _vm.payslip_month,
      callback: function ($$v) {
        _vm.payslip_month = $$v;
      },
      expression: "payslip_month"
    }
  ...
  }, [_vm._v("Close")])], 1)], 1)], 1), _vm._ssrNode(" "), _c(VDialog["a" /* default */], {
    attrs: {
      "fullscreen": false,
      "width": "600px"
    },
    model: {
      value: _vm.generatePayslipDialog,
      callback: function ($$v) {
        _vm.generatePayslipDialog = $$v;
      },
      expression: "generatePayslipDialog"
    }
  }, [_c(VCard["a" /* default */], [_c(components_VCard["e" /* VCardTitle */], {
    staticClass: "primary white--text background",
    attrs: {
    ...
    on: {
      "click": function ($event) {
        _vm.generatePayslipDialog = false;
      }
    }
  }, [_vm._v("\n           mdi mdi-close-circle\n         ")])], 1), _vm._v(" "), _c(components_VCard["d" /* VCardText */], [_c(VContainer["a" /* default */], [_c(VRow["a" /* default */], {
    staticClass: "mt-4"
  }, [_c(VCol["a" /* default */], {
    attrs: {
      "cols": "5"
    }
  }, [_c('div', {}, [_vm._v("Departments")]), _vm._v(" "), _c(VSelect["a" /* default */], {
    attrs: {
      "outlined": "",
      "dense": "",
      "x-small": "",
    ...
    model: {
      value: _vm.department_idPopup,
      callback: function ($$v) {
        _vm.department_idPopup = $$v;
      },
      expression: "department_idPopup"
    }
  })], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "3"
    }
  }, [_c('div', {}, [_vm._v("Year")]), _vm._v(" "), _c(VSelect["a" /* default */], {
    attrs: {
      "outlined": "",
      "dense": "",
      "x-small": "",
    ...
    model: {
      value: _vm.payslip_year_Popup,
      callback: function ($$v) {
        _vm.payslip_year_Popup = $$v;
      },
      expression: "payslip_year_Popup"
    }
  })], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "3"
    }
  }, [_c('div', {}, [_vm._v("Month")]), _vm._v(" "), _c(VSelect["a" /* default */], {
    attrs: {
      "outlined": "",
      "dense": "",
      "x-small": "",
    ...
    model: {
      value: _vm.payslip_month_Popup,
      callback: function ($$v) {
        _vm.payslip_month_Popup = $$v;
      },
      expression: "payslip_month_Popup"
    }
  })], 1), _vm._v(" "), _c(components_VCard["b" /* VCardActions */], [_c(VCol["a" /* default */], {
    staticStyle: {
      "padding": "0px"
    },
    attrs: {
    ...
    staticClass: "primary",
    on: {
      "click": _vm.generateNewpayslipsByDepartment
    }
  }, [_vm._v("Generate Payslips")])], 1)], 1)], 1)], 1)], 1)], 1)], 1), _vm._ssrNode(" "), _vm.can(`employee_view`) ? _vm._ssrNode("<div>", "</div>", [_c(VRow["a" /* default */], [_c(VCol["a" /* default */], [_c(VCard["a" /* default */], {
    staticClass: "mb-5",
    attrs: {
      "elevation": "0"
    }
  }, [_c(VToolbar["a" /* default */], {
    staticClass: "rounded-md mb-2 white--text",
    attrs: {
      "color": "background",
      "dense": "",
      "flat": ""
  ...
  }, [_c('span', [_vm._v(" Payslips")]), _vm._v(" "), _c(VTooltip["a" /* default */], {
    attrs: {
      "top": "",
      "color": "primary"
    },
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        }, [_vm._v("mdi-filter-multiple ")])], 1)];
      }
    }], null, false, 358008263)
  }, [_vm._v(" "), _c('span', [_vm._v(" Filter By Department ")])]), _vm._v(" "), _c(VTooltip["a" /* default */], {
    attrs: {
      "top": "",
      "color": "primary"
    },
    ...
    }], null, false, 3998732552)
  }, [_vm._v(" "), _c('span', [_vm._v(" Filter ")])]), _vm._v(" "), _vm.selectedItems.length ? _c(VBtn["a" /* default */], {
    directives: [{
      name: "btn",
      rawName: "v-btn"
    }],
    staticClass: "primary toolbar-button-design1",
    attrs: {
      "small": "",
      "color": "primary"
    },
    on: {
      "click": _vm.generateNewpayslipsSelected
    }
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_c(VBtn["a" /* default */], _vm._g(_vm._b({
          ...
          on: {
            "click": _vm.openPayslipDialog
          }
        }, [_vm._v("mdi-briefcase-outline")])], 1)];
      }
    }], null, false, 708089468)
  }, [_vm._v(" "), _c('span', [_vm._v("Generate Payslips by Department")])]), _vm._v(" "), _c(VTooltip["a" /* default */], {
    attrs: {
      "top": "",
      "color": "primary"
    },
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_vm.downloadAllDisplayStatus ? _c(VBtn["a" /* default */], _vm._g(_vm._b({
          staticClass: "ma-0 px-0",
          attrs: {
            "dense": "",
            "x-small": "",
            ...
            "text": "",
            "download": "",
            "href": _vm.payslipsDownloadAllURL,
            "small": ""
          }
        }, 'v-btn', attrs, false), on), [_c(VIcon["a" /* default */], {
          staticClass: "mx-1 white--text",
        ...
        }, [_vm._v("mdi\n                       mdi-download")])], 1) : _vm._e()];
      }
    }], null, false, 331886553)
  }, [_vm._v(" "), _c('span', [_vm._v("Download All Payslips")])])], 1)], 1), _vm._v(" "), _c(VSnackbar["a" /* default */], {
    attrs: {
      "timeout": 3000,
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_vm.isFilter ? _c('tr', _vm._l(headers, function (header) {
          ...
          }) : _vm._e(), _vm._v(" "), header.filterSpecial && header.value == 'department_name' ? _c(VSelect["a" /* default */], {
            attrs: {
              "id": header.key,
              "hide-details": true,
              "outlined": "",
      ...
      fn: function ({
        ...
        return [_vm._v("\n               " + _vm._s(item.payroll_month) + " / " + _vm._s(item.payroll_year) + "\n             ")];
      }
    }, {
      key: "item.payroll.basic_salary",
      fn: function ({
        item
      }) {
        return [_vm._v("\n               " + _vm._s(item.payroll && item.payroll.basic_salary) + "\n             ")];
      }
    }, {
      key: "item.payroll.net_salary",
      fn: function ({
        item
      }) {
        return [_vm._v("\n               " + _vm._s(item.payroll && item.payroll.net_salary) + "\n             ")];
      }
    }, {
      key: "item.payslip",
      fn: function ({
        ...
        var _item$payroll, _item$payroll2;
        return [item !== null && item !== void 0 && (_item$payroll = item.payroll) !== null && _item$payroll !== void 0 && _item$payroll.basic_salary ? _c('span', {
          staticStyle: {
            "font-size": "25px",
            "vertical-align": "inherit",
            "cursor": "pointer"
          ...
          on: {
            "click": function ($event) {
              return _vm.navigateToViewPDF(item.employee_id);
            }
          }
        }, [_c(VIcon["a" /* default */], {
          staticClass: "primary--text",
        ...
        }, [_vm._v("mdi-eye")])], 1) : _vm._e(), _vm._v(" "), item !== null && item !== void 0 && (_item$payroll2 = item.payroll) !== null && _item$payroll2 !== void 0 && _item$payroll2.basic_salary ? _c('a', {
          staticStyle: {
            "font-size": "25px",
            "vertical-align": "inherit",
            "cursor": "pointer"
  ...
  })], 1)], 1)], 1), _vm._ssrNode(" <div></div>")], 2) : _c('NoAccess')], 2) : _c('NoAccess');
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/payroll/salary/index.vue?vue&type=template&id=046beb68&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/payroll/salary/index.vue?vue&type=script&lang=js&
/* harmony default export */ var salaryvue_type_script_lang_js_ = ({
  data: () => ({
    filterLoader: false,
    filters: {},
    isFilter: false,
    ...
    Allowance: ["Transport", "Travel", "Entertainment", "Housing", "Uniform", "Uniform", "Medical/health"],
    headers: [{
      text: "#"
    }, {
      text: "E.ID"
  ...
  methods: {
    ...
    downloadAllPayslipsError() {
      this.snackbar = true;
      this.response = "Payslips are not available. Please generate and try again";
      return false;
    },
    ...
    getBankInfo(id) {
      this.$axios.get(`bankinfo/${id}`).then(({
        data
      }) => {
        this.BankInfo = {
          ...data
    ...
    generateNewpayslipsByDepartment() {
      ...
      this.$axios.get(`payslip-by-department`, options).then(({
        data
      }) => {
    ...
    generateNewpayslipsSelected() {
      ...
      this.$axios.get(`/generate-payslips-with-employeeids`, options).then(({
        data
      }) => {
        this.payslipsResultsmessages = [];
        this.dialogPayslipsResults = true;
    ...
    getDataFromApi(url = this.endpoint, search_column_name = "") {
      ...
      this.$axios.get(`${url}?page=${page}`, options).then(({
        ...
        this.data.forEach(element => {
          if (element.payslip_status) this.payslipsDownloadAllEmployeeidsArray.push(element.employee_id);
        });
        if (this.payslipsDownloadAllEmployeeidsArray.length > 0) {
          this.payslipsDownloadAllURL = this.$axios.defaults.baseURL + "/generate-payslips-zip?company_id=" + this.$auth.user.company_id + "&employee_ids=" + this.payslipsDownloadAllEmployeeidsArray + "&month=" + this.payslip_month + "&year=" + this.payslip_year;
    ...
    save() {
      ...
      if (this.editedIndex > -1) {
        this.$axios.put(this.endpoint + "/" + this.editedItem.id, salary).then(({
          data
        }) => {
          if (!data.status) {
            this.errors = data.errors;
        ...
        this.$axios.post(this.endpoint, salary).then(({
          data
        }) => {
          if (!data.status) {
            this.errors = data.errors;
...
// CONCATENATED MODULE: ./pages/payroll/salary/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var payroll_salaryvue_type_script_lang_js_ = (salaryvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(9);

// CONCATENATED MODULE: ./pages/payroll/salary/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  payroll_salaryvue_type_script_lang_js_,
  salaryvue_type_template_id_046beb68_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* harmony default export */ var salary = __webpack_exports__["default"] = (component.exports);

...
var shiftvue_type_template_id_0ecbfd9c_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.can(`shift_access`) ? _c('div', [_vm._ssrNode("<div class=\"text-center ma-2\">", "</div>", [_c(VSnackbar["a" /* default */], {
    attrs: {
      "top": "top",
      "color": "secondary",
      "elevation": "24"
  ...
  }, [_vm._v("\n      " + _vm._s(_vm.response) + "\n    ")])], 1), _vm._ssrNode(" "), _vm.can(`shift_view`) ? _c(VCard["a" /* default */], {
    attrs: {
      "elevation": "0"
    }
    ...
    }], null, false, 251911001)
  }, [_vm._v(" "), _c('span', [_vm._v("Add New Shift Details")])])], 1), _vm._v(" "), _c(VSnackbar["a" /* default */], {
    attrs: {
      "timeout": 3000,
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_vm._v(" " + _vm._s(item.shift_type.name) + "\n      ")];
      }
    }, {
      key: "item.on_duty_time",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(item.on_duty_time) + "\n      ")];
      }
    }, {
      key: "item.ending_in",
      fn: function ({
      ...
      key: "item.off_duty_time",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(item.off_duty_time) + "\n      ")];
      }
    }, {
      key: "item.beginning_out",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(item.beginning_out) + "\n      ")];
      }
    }, {
      key: "item.ending_out",
      fn: function ({
      ...
      key: "item.absent_min_in",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(item.absent_min_in) + "\n      ")];
      }
    }, {
      key: "item.absent_min_out",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(item.absent_min_out) + "\n      ")];
      }
    }, {
      key: "item.working_hours",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(item.working_hours) + "\n      ")];
      }
    }, {
      key: "item.overtime_interval",
      fn: function ({
        item
      }) {
        return [_vm._v("\n        " + _vm._s(item.overtime_interval) + "\n      ")];
      }
    }, {
      key: "item.actions",
      fn: function ({
    ...
    }], null, false, 3514462663)
  })], 1) : _c('NoAccess')], 2) : _c('NoAccess');
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/shift/index.vue?vue&type=template&id=0ecbfd9c&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/shift/index.vue?vue&type=script&lang=js&
/* harmony default export */ var shiftvue_type_script_lang_js_ = ({
  data: () => ({
    totalRowsCount: 0,
    isFilter: false,
    filters: {},
...
// CONCATENATED MODULE: ./pages/shift/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_shiftvue_type_script_lang_js_ = (shiftvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(9);

// CONCATENATED MODULE: ./pages/shift/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_shiftvue_type_script_lang_js_,
  shiftvue_type_template_id_0ecbfd9c_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* harmony default export */ var shift = __webpack_exports__["default"] = (component.exports);

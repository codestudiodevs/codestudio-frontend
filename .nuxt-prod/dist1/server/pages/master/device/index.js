...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/master/device/index.vue?vue&type=template&id=b7a1b7dc&
...
var devicevue_type_template_id_b7a1b7dc_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.can('master') ? _c('div', [_vm._ssrNode("<div class=\"text-center ma-2\">", "</div>", [_c(VSnackbar["a" /* default */], {
  ...
  }, [_c('h3', [_vm._v("device")]), _vm._v(" "), _c('div', [_vm._v("Dashboard / device")])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "6"
    }
  }, [_c('div', {
  ...
  }, [_vm._v("Delete Selected Records")]), _vm._v(" "), _c(VBtn["a" /* default */], {
    staticClass: "mb-2",
    attrs: {
      "small": "",
      "color": "primary",
  ...
  }, [_vm._v("device +")])], 1)])], 1), _vm._ssrNode(" "), _c(VDataTable["a" /* default */], {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        }, [_vm._v("\n        " + _vm._s(item.device === "customer" ? "" : "mdi-delete") + "\n      ")])];
      }
    }, {
      key: "no-data",
      fn: function () {
...
// CONCATENATED MODULE: ./pages/master/device/index.vue?vue&type=template&id=b7a1b7dc&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/master/device/index.vue?vue&type=script&lang=js&
/* harmony default export */ var devicevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getDataFromApi(url = this.endpoint) {
      var _this$$auth$user, _this$$auth$user$comp;
      this.loading = true;
      const {
        sortBy,
        sortDesc,
      ...
      let options = {
        params: {
          ...
          company_id: (_this$$auth$user = this.$auth.user) === null || _this$$auth$user === void 0 ? void 0 : (_this$$auth$user$comp = _this$$auth$user.company) === null || _this$$auth$user$comp === void 0 ? void 0 : _this$$auth$user$comp.id
        }
      };
    ...
    save() {
      ...
      if (this.editedIndex > -1) {
        this.$axios.put(this.endpoint + "/" + this.editedItem.id, payload).then(res => {
          if (!res.data.status) {
            this.errors = res.data.errors;
          } else {
            const index = this.devices.findIndex(item => item.id == this.editedItem.id);
            this.devices.splice(index, 1, {
        ...
        this.$axios.post(this.endpoint, payload).then(res => {
          if (!res.data.status) {
            this.errors = res.data.errors;
          } else {
            this.getDataFromApi();
...
// CONCATENATED MODULE: ./pages/master/device/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var master_devicevue_type_script_lang_js_ = (devicevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(9);

// CONCATENATED MODULE: ./pages/master/device/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  master_devicevue_type_script_lang_js_,
  devicevue_type_template_id_b7a1b7dc_render,
  staticRenderFns,
  false,
  null,
  null,

...
var createvue_type_template_id_cdf885b4_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.can('master') ? _c('div', [_vm._ssrNode("<div class=\"text-center ma-2\">", "</div>", [_c(VSnackbar["a" /* default */], {
  ...
  }, [_vm._v("Assign Modules")])]), _vm._v(" "), _c(VCol["a" /* default */], [_c('div', {
  ...
  })], 1), _vm._v(" "), _vm._l(_vm.modules, function (pa, idx) {
    return _c(VCol["a" /* default */], {
      ...
      model: {
        value: _vm.module_ids,
        callback: function ($$v) {
          _vm.module_ids = $$v;
        },
        expression: "module_ids"
      }
    })], 1);
  }), _vm._v(" "), _vm.errors && _vm.errors.module_ids ? _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12"
    }
  }, [_c('span', {
    staticClass: "error--text"
  }, [_vm._v(_vm._s(_vm.errors.module_ids[0]))])]) : _vm._e(), _vm._v(" "), _c(VCol["a" /* default */], [_vm.can('assign_module_create') ? _c(VBtn["a" /* default */], {
    staticClass: "mr-4",
    attrs: {
      "loading": _vm.loading,
      "dark": "",
  ...
  }, [_vm._v("\n                Submit\n              ")]) : _vm._e()], 1)], 2)], 1)], 1)], 1)], 1)], 2) : _c('NoAccess');
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/master/assign_module/create.vue?vue&type=template&id=cdf885b4&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/master/assign_module/create.vue?vue&type=script&lang=js&
/* harmony default export */ var createvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getCompanies() {
      this.$axios.get("assign-module/nacs").then(({
        data
      }) => {
        this.loading = false;
        this.companies = data;
    ...
    save() {
      if (this.$refs.form.validate()) {
        ...
        this.$axios.post("assign-module", payload).then(({
          data
        }) => {
          if (!data.status) {
...
// CONCATENATED MODULE: ./pages/master/assign_module/create.vue?vue&type=script&lang=js&
 /* harmony default export */ var assign_module_createvue_type_script_lang_js_ = (createvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(9);

// CONCATENATED MODULE: ./pages/master/assign_module/create.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  assign_module_createvue_type_script_lang_js_,
  createvue_type_template_id_cdf885b4_render,
  staticRenderFns,
  false,
  null,
  null,

...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/_id.vue?vue&type=template&id=535e15c5&
...
var _idvue_type_template_id_535e15c5_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.can(`user_access`) ? _c('div', [_vm._ssrNode("<div class=\"text-center ma-2\">", "</div>", [_c(VSnackbar["a" /* default */], {
    ...
    staticClass: "text-danger"
  }, [_vm._v("(leave empty if no change)")])]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  }, [_vm.can(`user_edit`) ? _c(VBtn["a" /* default */], {
    attrs: {
      "small": "",
      "loading": _vm.loading,
      "color": "primary"
...
// CONCATENATED MODULE: ./pages/user/_id.vue?vue&type=template&id=535e15c5&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/_id.vue?vue&type=script&lang=js&
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    getRecord() {
      this.$axios.get(`users/${this.id}`).then(({
        data
      }) => {
        this.payload = data;
      });
    ...
    store_device() {
      ...
      this.loading = true;
      this.$axios.put(`/users/${this.id}`, this.payload).then(({
        data
      }) => {
        this.loading = false;
        if (!data.status) {
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  _idvue_type_template_id_535e15c5_render,
  staticRenderFns,
  false,
  null,
  null,

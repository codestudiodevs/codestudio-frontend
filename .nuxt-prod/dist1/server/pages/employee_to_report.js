...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/employee_to_report.vue?vue&type=template&id=5beefc56&
...
var employee_to_reportvue_type_template_id_5beefc56_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.can(`department_access`) ? _c('div', [_vm._ssrNode("<div class=\"text-center ma-2\">", "</div>", [_c(VSnackbar["a" /* default */], {
  ...
  }, [_vm.can(`department_delete`) ? _c(VBtn["a" /* default */], {
    ...
    on: {
      "click": _vm.delteteSelectedRecords
    }
  }, [_vm._v("Delete Selected Records")]) : _vm._e(), _vm._v(" "), _vm.can(`department_create`) ? _c(VBtn["a" /* default */], {
    staticClass: "mb-2",
    attrs: {
      "small": "",
      "color": "primary"
  ...
  }, [_vm._v(_vm._s(_vm.Model) + " +")]) : _vm._e()], 1)])], 1), _vm._ssrNode(" "), _c(VDialog["a" /* default */], {
    attrs: {
      "max-width": "800px",
      "persistent": ""
    },
  ...
  }, [_c(VCard["a" /* default */], [_c(components_VCard["e" /* VCardTitle */], [_c('span', {
    staticClass: "headline"
  }, [_vm._v(_vm._s(_vm.formTitle) + " " + _vm._s(_vm.Model))])]), _vm._v(" "), _c(components_VCard["d" /* VCardText */], [_c(VContainer["a" /* default */], [_c(VRow["a" /* default */], [_c(VCol["a" /* default */], {
    attrs: {
      "cols": "12"
    }
  ...
  }, [_vm._v(_vm._s(_vm.errors.employee_id[0]))]) : _vm._e()], 1), _vm._v(" "), _vm.employee_grade ? _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12"
    }
  }, [_c(VAutocomplete["a" /* default */], {
    attrs: {
      "label": "Report",
      "items": _vm.employees_list,
      "item-text": "first_name",
      "item-value": "id",
      "multiple": _vm.employee_grade && _vm.employee_grade == 'C' ? true : false
    },
    model: {
      value: _vm.editedItem.to_report,
      callback: function ($$v) {
        _vm.$set(_vm.editedItem, "to_report", $$v);
      },
      expression: "editedItem.to_report"
    }
  }), _vm._v(" "), _vm.errors && _vm.errors.to_report ? _c('span', {
    staticClass: "error--text"
  }, [_vm._v(_vm._s(_vm.errors.to_report[0]))]) : _vm._e()], 1) : _vm._e()], 1)], 1)], 1), _vm._v(" "), _c(components_VCard["b" /* VCardActions */], [_c(VSpacer["a" /* default */]), _vm._v(" "), _c(VBtn["a" /* default */], {
    staticClass: "error",
    attrs: {
      "small": ""
    },
  ...
  }, [_vm._v("Save")])], 1)], 1)], 1), _vm._ssrNode(" "), _vm.can(`employee_report`) ? _c(VDataTable["a" /* default */], {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        return [_vm.can(`department_edit`) ? _c(VIcon["a" /* default */], {
          staticClass: "mr-2",
          attrs: {
            "color": "secondary",
            "small": ""
        ...
        }, [_vm._v("\n        mdi-pencil\n      ")]) : _vm._e(), _vm._v(" "), _vm.can(`department_delete`) ? _c(VIcon["a" /* default */], {
          attrs: {
            "color": "error",
            "small": ""
          },
      ...
      fn: function ({
        ...
        return _vm._l(item && item.report_to, function (rep, index) {
          return _c('span', {
            key: index
          }, [_c(VChip["a" /* default */], {
          ...
          }, [_vm._v("\n          " + _vm._s(rep.first_name) + "\n        ")])], 1);
        });
      }
    }], null, false, 3319618953),
    model: {
      value: _vm.ids,
      callback: function ($$v) {
        _vm.ids = $$v;
  ...
  }) : _c('NoAccess')], 2) : _c('NoAccess');
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/employee_to_report.vue?vue&type=template&id=5beefc56&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/employee_to_report.vue?vue&type=script&lang=js&
/* harmony default export */ var employee_to_reportvue_type_script_lang_js_ = ({
  data: () => ({
  ...
  methods: {
    getEmployees() {
      ...
      this.$axios.get(`employee`, options).then(({
        ...
        this.employees = data.data.filter(e => e.report_to.length == 0 ? e : null);
      });
    },
    changeEmployeeType() {
      ...
      this.$axios.get(`employee/${id}`).then(({
        ...
        this.employees_list = this.all_employees.filter(e => e.id != this.editedItem.employee_id ? e : null);
      });
    },
    ...
    deleteItem(item) {
      confirm("Are you sure you wish to delete , to mitigate any inconvenience in future.") && this.$axios.delete(`employee_remove_reporters` + "/" + item.id).then(({
        data
      }) => {
    ...
    save() {
      ...
      let id = this.editedItem.employee_id;
      this.$axios.post(`employee_to_reporter/${id}`, payload).then(({
        data
      }) => {
        if (!data.status) {
...
// CONCATENATED MODULE: ./pages/employee_to_report.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_employee_to_reportvue_type_script_lang_js_ = (employee_to_reportvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(9);

// CONCATENATED MODULE: ./pages/employee_to_report.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_employee_to_reportvue_type_script_lang_js_,
  employee_to_reportvue_type_template_id_5beefc56_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* harmony default export */ var employee_to_report = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=employee_to_report.js.map
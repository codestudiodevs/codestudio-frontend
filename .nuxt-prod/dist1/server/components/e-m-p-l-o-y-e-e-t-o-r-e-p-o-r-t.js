...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/EMPLOYEETOREPORT.vue?vue&type=template&id=6c6c7560&
...
var EMPLOYEETOREPORTvue_type_template_id_6c6c7560_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.can(`department_access`) ? _c('div', [!_vm.loading ? _vm._ssrNode("<div>", "</div>", [_c(VDialog["a" /* default */], {
    attrs: {
      "max-width": "800px",
      "persistent": ""
    },
  ...
  }, [_vm._v(_vm._s(_vm.formTitle) + " " + _vm._s(_vm.Model))])]), _vm._v(" "), _c(components_VCard["d" /* VCardText */], [_c(VContainer["a" /* default */], [_c(VRow["a" /* default */], [_vm.employee_grade ? _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12"
    }
  ...
  }, [_vm._v("Save")])], 1)], 1)], 1), _vm._ssrNode(" "), _c(VRow["a" /* default */], [_c(VCol["a" /* default */], {
    attrs: {
      "md": "12",
      "cols": "12"
    }
  ...
  }, [_vm.can('employee_edit') ? _c(VIcon["a" /* default */], {
    staticClass: "grey",
    staticStyle: {
      "border-radius": "50%",
      "padding": "5px"
  ...
  }, [_vm._v("mdi-plus")]) : _vm._e()], 1)])], 1), _vm._ssrNode(" "), _vm.can('employee_view') ? _c(VRow["a" /* default */], _vm._l(_vm.reporters, function (item, index) {
    ...
    }, [_c(components_VCard["e" /* VCardTitle */], [_c(VSpacer["a" /* default */]), _vm._v(" "), _vm.can(`employee_delete`) ? _c(VIcon["a" /* default */], {
      attrs: {
        "color": "red",
        "small": ""
      },
    ...
    })], 1), _vm._v(" "), _c('div', [_c('b', [_vm._v(_vm._s(item.first_name))])]), _vm._v(" "), _c('div', [_vm._v("\n              " + _vm._s(item.designation && item.designation.name || "") + "\n            ")])])], 1)], 1);
  }), 1) : _vm._e()], 2) : _c('Preloader', {
    staticStyle: {
      "margin": "0 0 0 750px"
    }
  })], 1) : _vm._e();
...
// CONCATENATED MODULE: ./components/EMPLOYEETOREPORT.vue?vue&type=template&id=6c6c7560&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/EMPLOYEETOREPORT.vue?vue&type=script&lang=js&
/* harmony default export */ var EMPLOYEETOREPORTvue_type_script_lang_js_ = ({
  props: ["currentUser"],
  data: () => ({
  ...
  methods: {
    ...
    getEmployeeDetails() {
      this.$axios.get(`employee/${this.currentUser}`).then(({
        data
      }) => {
    ...
    getReporters() {
      ...
      this.$axios.get(`reporter_by_employee/${id}`).then(({
        data
      }) => {
        this.reporters = data;
    ...
    changeEmployeeType() {
      ...
      this.$axios.get(`employee/${id}`).then(({
        ...
        this.employees_list = this.all_employees.filter(e => e.id != this.currentUser ? e : null);
      });
    },
    can(per) {
    ...
    deleteItem(item) {
      ...
      confirm("Are you sure you wish to delete , to mitigate any inconvenience in future.") && this.$axios.delete(`employee_remove_reporters` + "/" + this.currentUser, payload).then(({
        data
      }) => {
    ...
    isEmployeeGradeA() {
      if (this.singleEmployee && this.singleEmployee.grade == "A") {
        alert("You cannot assign reporter " + this.singleEmployee.first_name + " employee grade A ");
        return true;
      }
    }
  }
});
// CONCATENATED MODULE: ./components/EMPLOYEETOREPORT.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_EMPLOYEETOREPORTvue_type_script_lang_js_ = (EMPLOYEETOREPORTvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(9);

// CONCATENATED MODULE: ./components/EMPLOYEETOREPORT.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  components_EMPLOYEETOREPORTvue_type_script_lang_js_,
  EMPLOYEETOREPORTvue_type_template_id_6c6c7560_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* harmony default export */ var EMPLOYEETOREPORT = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=e-m-p-l-o-y-e-e-t-o-r-e-p-o-r-t.js.map